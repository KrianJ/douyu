...
USER_AGENT = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.69 Safari/537.36 Edg/85.0.564.36'
...
DEFAULT_REQUEST_HEADERS = {
    ...
    'Accept-Language': 'enzh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7',
...
ITEM_PIPELINES = {
   'douyu.pipelines.MongoPipeline': 300,
}
